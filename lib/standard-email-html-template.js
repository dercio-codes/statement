    ...
    return `
         ...
         <div style = 'background: #222; padding: 20px;  border: 1px #ddd solid; margin-bottom:20px ;max-width:900px; margin:auto; margin-bottom: 30px;'>
            ...
            <div  style='display: flex; margin-bottom: 20px; align-items: baseline;'>
             ...
             <div  style='display: flex; margin-bottom: 20px; align-items: baseline;'>
                     <div style='font-weight: 700; background: #111; padding: 10px; min-width: 50%; margin-right: 20px ; flex: 1 !important ; text-align:right '>Names of People at Table : </div>
                     <div style=' background: rgba(0,0,0,.02); padding: 10px; flex:2 !important' >${ names_of_people && names_of_people.map((item)=> `${item}` )}
                     </div>
             </div>
         </div>
